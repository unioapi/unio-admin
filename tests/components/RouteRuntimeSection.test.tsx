...
function runtimeFixture(): RouteRuntime {
  const common = {
    ...
    endpoint_state_generation: 4,
    endpoint_base_url_fence_generation: 5,
    endpoint_status_fence_generation: 6,
    ...
    endpoint_breaker_state: "closed" as const,
...
function legacyDecisionFixture(): RoutingDecision {
  return {
    ...
    candidate_scores: [
      {
        ...
        route_index: 0,
        eligible: true,
        candidate_endpoint_base_url_revision: 2,
        runtime_endpoint_base_url_revision: 2,
        endpoint_base_url_revision_current: true,
        candidate_endpoint_status_revision: 3,
        runtime_endpoint_status_revision: 3,
        endpoint_status_revision_current: true,
    ...
    selected_order: [10],
    fallback_chain: [
      { channel_id: 10, upstream_operation: "responses_compact" },
      { channel_id: 10, upstream_operation: "chat_completions" },
    ],
    final_channel_id: 10,
...
describe("RouteRuntimeSection", () => {
  ...
  it("marks observations older than ten seconds stale and shows hard exclusions", async () => {
    ...
    expect(
      screen.getByRole("columnheader", { name: "Endpoint 熔断" }),
    ).toBeVisible();
    expect(
